...
from data.load_experiments import FlatLizard, unseen_setup
...
if __name__ == '__main__':
    for seed in seed_ls:
        ...
        C_train, C_test, _, _, X, X_test, _ = unseen_setup(FlatLizard(split=1), sparsity=0.7)
